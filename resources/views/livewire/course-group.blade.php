<div class="">
    ...
    <div class="flex">
        <div class="w-[26rem] p-1 border-b {{$further ? 'border-x' : ''}}"><b>{{ $further ?  $courseGroup['name'] : $courseGroup['specializations'][0]['name'] }}</b></div>
       @if(!$further) <div class="w-10 border-b"></div>@endif
