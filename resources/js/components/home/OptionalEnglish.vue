...
<template>
  <div v-if="courseData">
    <h2 class="mt-10">Optional English Class for MSc Students (no ECTS gained)</h2>
...
interface Props { courseData: ICourseDataResponse }
const props = defineProps<Props>(),

 description: IText | undefined = props.courseData.optional_courses?.texts.find(
